          ...
          <div className="flex-1 w-full min-w-0">
            <Reveal delay={120}>
              <h3 className="text-xl sm:text-2xl font-serif font-semibold text-foreground mb-2">
                ...
                <span className="text-primary not-italic"> in your pocket</span>
              </h3>
              <p className="text-sm text-muted-foreground mb-6">
                Swipe through a few of the powerful screens available right from your phone.
              </p>
            </Reveal>

            {/* Big active screenshot */}
            <Reveal delay={200}>
              <div className="relative overflow-hidden rounded-2xl border border-border bg-card shadow-sm mb-4 ms-screenshot-frame">
                <div className="absolute top-3 left-3 z-10 px-3 py-1 rounded-full bg-primary/90 text-primary-foreground text-xs font-semibold backdrop-blur shadow-sm">
                ...
                <button
                  ...
                  className="absolute left-2 top-1/2 -translate-y-1/2 z-10 p-2 rounded-full bg-black/30 hover:bg-black/50 text-white backdrop-blur transition-all text-xl leading-none"
                  aria-label="Previous"
                >
                  &#8249;
                </button>
                <button
                  ...
                  className="absolute right-2 top-1/2 -translate-y-1/2 z-10 p-2 rounded-full bg-black/30 hover:bg-black/50 text-white backdrop-blur transition-all text-xl leading-none"
                  aria-label="Next"
                >
                  &#8250;
                </button>
