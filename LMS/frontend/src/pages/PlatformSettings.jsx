            ...
            <div className="max-w-2xl mx-auto space-y-8 py-4">
                ...
                <div className="card-premium overflow-hidden">
                    <div className="p-8 border-b border-slate-100 bg-slate-50/50">
                        <h3 className="text-xl font-semibold text-slate-900 mb-1">Financial Rates (%)</h3>
                    ...
                    <form onSubmit={handleSave} className="p-8 space-y-8">
                        ...
                        <div className="bg-primary/10 p-6 rounded-xl border border-primary/20 flex items-center justify-between">
                            <div>
                                <h4 className="font-semibold text-slate-900">Enable Subscription Checking</h4>
                        ...
                        <div className="space-y-4">
                            <div>
                                <h4 className="font-semibold text-slate-900 flex items-center gap-2"><Brain className="w-4 h-4 text-primary" /> Active AI Provider</h4>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <button
                                    ...
                                    className={`relative p-5 rounded-xl border-2 text-left transition-all ${
                                        settings.activeAIProvider === 'groq'
                                            ? 'border-primary/50 bg-primary/10 shadow-none'
                                ...
                                >
                                    ...
                                    <span className="inline-block mt-2 text-xs font-semibold tracking-wider bg-green-100 text-green-700 px-2 py-0.5 rounded-full">Recommended</span>
                                </button>
                                ...
                                >
                                    ...
                                    <span className="inline-block mt-2 text-xs font-semibold tracking-wider bg-blue-100 text-blue-700 px-2 py-0.5 rounded-full">Google AI</span>
                                </button>
                            </div>
                        ...
                        <div className="bg-primary/10 p-6 rounded-xl border border-primary/20">
                            <div className="flex items-center justify-between">
                                <div>
                                    <h4 className="font-semibold text-slate-900 flex items-center gap-2"><Brain className="w-4 h-4 text-primary" /> AI Tutor for Students</h4>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        className="w-full pl-4 pr-10 py-2 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none"
                                        required
                                    />
                        ...
                        <div className="bg-primary/5 p-6 rounded-xl border border-primary/10">
                            <h4 className="text-sm font-semibold text-primary tracking-wider mb-2">Calculation Example:</h4>
                            <div className="space-y-1 text-sm text-slate-600">
                                <p>If a user pays <span className="font-semibold text-slate-900">₦10,000</span>:</p>
                                ...
                                <div className="mt-3 pt-3 border-t border-primary/10">
                                    <p className="text-primary font-semibold">Payable to Subscriber: ₦{(10000 - (10000 * (settings.taxRate + settings.vatRate + settings.serviceFeeRate) / 100)).toLocaleString()}</p>
                                </div>
                            </div>
                        </div>
