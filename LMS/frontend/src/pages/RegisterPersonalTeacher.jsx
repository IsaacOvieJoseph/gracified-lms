    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 flex items-center justify-center p-4">
      <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl p-8 w-full max-w-md transform transition-all hover:scale-[1.01]">
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-extrabold text-gray-900 mb-2">Personal Teacher</h2>
          <p className="text-gray-600">Start your independent teaching journey</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            <label htmlFor="tutorialName" className="block text-sm font-semibold text-gray-700 mb-2 ml-1">School / Tutorial Name</label>
            <input
              type="text"
              id="tutorialName"
              name="tutorialName"
              ...
              required
              className="w-full px-4 py-3 border border-gray-200 rounded-xl bg-gray-50 focus:bg-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200 outline-none"
              placeholder="Jane's Math Tutorials"
            />
          </div>
          <div>
            <label htmlFor="logo" className="block text-sm font-semibold text-gray-700 mb-2 ml-1">Logo / Profile Image (Optional)</label>
            <input
              type="file"
              id="logo"
              name="logo"
