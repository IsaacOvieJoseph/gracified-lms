        ...
        <div className="w-full max-w-lg animate-slide-up">
          ...
          <div className="card-premium p-8 md:p-10 bg-card max-h-[calc(100vh-4rem)] overflow-y-auto relative">
            ...
            <div className="text-center mb-8">
              <h1 className="font-outfit text-3xl font-bold text-foreground mb-2">Join as Student</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <button type="button" className="absolute inset-y-0 right-0 pr-4 flex items-center text-muted-foreground hover:text-foreground transition-colors"
              ...
              <div className="space-y-1.5">
                <label htmlFor="schoolId" className="block text-sm font-semibold text-foreground/80 ml-1">School / Tutorial Center</label>
                ...
                <p className="text-xs text-muted-foreground ml-1 mt-1">Select "None" if you don't belong to any specific school.</p>
              </div>

              {error && (
                <div className="p-4 rounded-xl bg-red-500/10 border border-red-500/30 text-sm text-red-500 dark:text-red-400 font-medium">
                  {error}
                </div>
              )}
              {message && (
                <div className="p-4 rounded-xl bg-emerald-500/10 border border-emerald-500/30 text-sm text-emerald-600 dark:text-emerald-400 font-medium">
                  {message}
                </div>
              )}
