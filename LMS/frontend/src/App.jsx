  ...
  if (loading) {
    return <div className="min-h-screen flex items-center justify-center bg-background">
      <div className="flex flex-col items-center gap-4">
        ...
        <p className="text-xs font-semibold tracking-wide text-muted-foreground opacity-50">Loading...</p>
      </div>
    </div>;
  }
    ...
    <div className="min-h-screen bg-background text-foreground flex items-center justify-center p-4 transition-colors duration-300">
      ...
      <div className="w-full max-w-lg bg-card border border-border  rounded-xl shadow-none p-8 relative z-10">
        ...
        <div className="space-y-4">
          <Link to={`/register/student${search}`} className="group relative flex items-center justify-between p-4 border-2 border-transparent bg-primary/10 rounded-xl hover:bg-background hover:border-primary/50 hover:shadow-none transition-all duration-300">
            <div className="flex items-center space-x-4">
              <div className="bg-primary/20 p-3 rounded-xl group-hover:bg-primary/90 transition-colors duration-300">
            ...
            <div className="text-primary opacity-0 group-hover:opacity-100 transform translate-x-[-10px] group-hover:translate-x-0 transition-all duration-300">→</div>
          </Link>

          <Link to={`/register/school-admin${search}`} className="group relative flex items-center justify-between p-4 border-2 border-transparent bg-emerald-500/10 rounded-xl hover:bg-background hover:border-emerald-500 hover:shadow-none transition-all duration-300">
            <div className="flex items-center space-x-4">
              <div className="bg-emerald-500/20 p-3 rounded-xl group-hover:bg-success/90 transition-colors duration-300">
          ...
          <Link to={`/register/personal-teacher${search}`} className="group relative flex items-center justify-between p-4 border-2 border-transparent bg-primary/10 rounded-xl hover:bg-background hover:border-primary/50 hover:shadow-none transition-all duration-300">
            <div className="flex items-center space-x-4">
              <div className="bg-primary/20 p-3 rounded-xl group-hover:bg-primary/90 transition-colors duration-300">
                <User className="w-6 h-6 text-primary group-hover:text-white transition-colors duration-300" />
              </div>
              <div>
                <h3 className="font-semibold text-foreground">Personal Teacher</h3>
