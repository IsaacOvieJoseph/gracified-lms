    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.content}>
        <View style={styles.hero}>
          ...
          <Text style={styles.subtitle}>A polished mobile experience for coursework, classes, and progress.</Text>
        </View>
        ...
        <View style={styles.panel}>
          ...
          <Text style={styles.panelText}>• A refined, professional mobile UI</Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  );
