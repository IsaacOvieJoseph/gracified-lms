...
export default function AITutorChatScreen({ route, navigation }) {
  ...
  const launchQuiz = (area, questionCount) => {
    const qty = questionCount || extractPracticeQuantityFromMessage(input) || 5;
    navigation.replace('AITutorQuiz', {
