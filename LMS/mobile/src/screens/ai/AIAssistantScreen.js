...
const initialForm = { subject: '', topicName: '', className: '', level: '', teacherHint: '', question: '', assignmentType: 'theory', examType: 'mcq', questionCount: '5', slideCount: '8', duration: '60' };
...
export default function AIAssistantScreen({ navigation }) {
  ...
  return <SafeAreaView style={[styles.container, { backgroundColor: theme.background }]}>
    ...
    <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
      ...
      {result && <Result result={result} mode={mode} theme={theme} />}
    </ScrollView>
  </SafeAreaView>;
}
...
function Result({ result, mode, theme }) {
